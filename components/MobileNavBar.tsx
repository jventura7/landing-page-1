...
export default function MobileNavBar() {
  return (
    <NavigationMenu.Root className="md:absolute md:top-0 z-[1]">
      <NavigationMenu.List className="flex flex-col items-left text-lg space-y-6">
        <NavigationMenu.Item className="relative">
          <NavigationMenu.Trigger className="flex items-center justify-between">
            Features <CaretDownIcon aria-hidden />
          </NavigationMenu.Trigger>
          <NavigationMenu.Content className="mt-4 w-full">
        ...
        <NavigationMenu.Item>
          <NavigationMenu.Link className="text-center" href="/">
            <h1>Login</h1>
          </NavigationMenu.Link>
        </NavigationMenu.Item>
